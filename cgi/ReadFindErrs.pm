...
sub handle_start
{
    ...
    {
        if($element =~ m/^(extraHypWord|missingRefWord|untranslatedHypWord|unequalAlignedTokens|ordErrorShiftWord|ordErrorSwitchWords|otherMismatch|inflectionalError|reorderingError)$/)
        {
